...
bool Adafruit_BMP280::begin(uint8_t a, uint8_t chipid) {
  ...
  readCoefficients();
  write8(BMP280_REGISTER_CONTROL, 0x2F); //replace <0xnn> with your settings for the control register
  write8(BMP280_REGISTER_CONFIG, 0x04); //replace <0xnn> with your settings for the config register
  return true;
}
